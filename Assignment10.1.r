...
#Q) a. Read the file in Zip format and get it into R

#Ans :
airquality <- read.csv("C:/AirQuality.csv")
airquality  

# Q) b. Create Univariate for all the columns.
...
#Visually we can show it as follows : 
library(purrr)
library(tidyr)
library(ggplot2)
...
#Q) c. Check for missing values in all columns.
...
#Q) d. Impute the missing values using appropriate methods
...
# In this case we are using predictive mean matching as imputation 
# method
...
#Q e. Create bi-variate analysis for all relationships
...
#Q f. Test relevant hypothesis for valid relations
...
#as p value of this test is <0.05 we reject the null hypothesis
...
#Q g. Create cross tabulations with derived variables
...
#Q h. check for trends and patterns in time series

# Ans : Not discussed in our class yet 

#Q i. Find out the most polluted time of the day 
# and the name of the chemical compound.
